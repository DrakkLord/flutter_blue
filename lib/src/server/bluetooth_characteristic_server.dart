...
class BluetoothCharacteristicServer {
  final Guid uuid;
  final DeviceIdentifier deviceId;
  final Guid serviceUuid;
  final Guid secondaryServiceUuid;
  final CharacteristicProperties properties;
  final List<BluetoothDescriptorServer> descriptors;
  ...
  BluetoothCharacteristicServer.fromProto(protos.BluetoothCharacteristic p)
      : uuid = new Guid(p.uuid),
        ...
        descriptors = p.descriptors
            .map((d) => new BluetoothDescriptorServer.fromProto(d))
            .toList(),
  ...
  BluetoothCharacteristicServer.forServer(Guid uuid,
      CharacteristicProperties properties,
      { List<BluetoothDescriptorServer> descriptors,
      ...
      : uuid = uuid,
        ...
        descriptors = <BluetoothDescriptorServer>[]..addAll(descriptors??<BluetoothDescriptorServer>[]),
