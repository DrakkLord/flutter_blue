...
GPB_FINAL @interface ProtosServerAdvertisePayload : GPBMessage
...
GPB_FINAL @interface ProtosRequestMTURequest : GPBMessage
...
GPB_FINAL @interface ProtosRequestMTUResult : GPBMessage
